...
export function Header () {
    ...
    return (
        <header className="relative flex h-18 justify-center bg-secondary py-6 mb-28 lg:mb-24 md:mb-24">
            ...
            <img src={'/thiago-guerra.webp'} alt="perfil" className="absolute rounded-full border-primary w-24 h-24-bottom-16 md:-bottom-16 sm:w-32 sm:h-32"/>
        </header>
    )
}